...
{
    public partial class GameMediumView : Window
    {
        private readonly GameRecordManager _gameRecordManager;

        #region Constructors

        public GameMediumView(Player player)
        {
            InitializeComponent();
            ViewModel.Score = 0;
        ...
        public PairGameMediumVM ViewModel => DataContext as PairGameMediumVM;
        ...
        private void NewGame_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (ViewModel.State == StateOfGame.GameOver)
            {
                ...
                for (int i = 0; i < 36; i++) gameGrid.Children[i].Visibility = Visibility.Visible;
